...
$(window).on('load', function() {
  ...
  $.getJSON("./catalog.json", function(catalog){
    ...
    catalog.forEach(product => {
      ...
      $( `[data-productid="${product.id}"]` ).click(function(){
        console.log(this);
      });
    });
    ...
    cart.forEach(i => {
      ...
      $( ".cart-list" ).append( `<li class="cart-element list-group-item justify-content-between align-items-center" data-productid="${product.id}">${product.name}<button class="btn"><i class="text-primary fa-regular fa-trash-can"></i></button></li>` );
    });
